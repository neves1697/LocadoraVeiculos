...
public class Input {
    ...
    public static Scanner leitor = new Scanner(System.in); //variável de leitura do teclado

    public static Scanner leitorStrings = new Scanner(System.in); // scanner para ler Strings

    public static Date leitorData() {
        int err = -1;
        Date data = null;
        do {
            try {
                err = 0;
                data = getDateFormat().parse(next());

            } catch (ParseException e) {
                System.out.print("\nFormato de data invalido! Tente novamente: \n>");
                err = 1;
            }
        } while (err != 0);
        return data;
    ...
    public static String nextLine() {
        ...
        return leitorStrings.useDelimiter("\\n").next();
    }
